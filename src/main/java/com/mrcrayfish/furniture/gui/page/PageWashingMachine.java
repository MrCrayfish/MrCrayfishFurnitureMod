...
public class PageWashingMachine extends RecipePage
{
	...
	public void draw(GuiRecipeBook gui, int x, int y, int mouseX, int mouseY, float partialTicks)
	{
		...
		gui.getFontRenderer().drawString("repaired in the wash-", x + 150, 50, 16739840);
		gui.getFontRenderer().drawString("ing machine.", x + 150, 60, 16739840);
		
		gui.getFontRenderer().drawString("All items below can be", x + 4, 40, 16739840);
		gui.getFontRenderer().drawString("repaired in the wash-", x + 4, 50, 16739840);
		gui.getFontRenderer().drawString("ing machine.", x + 4, 60, 16739840);
