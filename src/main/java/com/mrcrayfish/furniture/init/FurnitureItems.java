...
public class FurnitureItems
{
	...
	{
		itemTableWood        = new ItemPlacer(FurnitureBlocks.table_wood).setUnlocalizedName("item_table_wood").setCreativeTab(MrCrayfishFurnitureMod.tabFurniture);
		itemTableStone       = new ItemPlacer(FurnitureBlocks.table_stone).setUnlocalizedName("item_table_stone").setCreativeTab(MrCrayfishFurnitureMod.tabFurniture);
		...
		itemCouch            = new ItemNotAdded().setUnlocalizedName("item_couch").setCreativeTab(MrCrayfishFurnitureMod.tabFurniture);
		...
		itemBirdBath = new ItemPlacer(FurnitureBlocks.bird_bath).setUnlocalizedName("item_bird_bath").setCreativeTab(MrCrayfishFurnitureMod.tabFurniture);
		...
		itemEnvelope = new ItemEnvelope().setUnlocalizedName("item_envelope").setCreativeTab(MrCrayfishFurnitureMod.tabFurniture);
		itemEnvelopeSigned = new ItemEnvelopeSigned().setUnlocalizedName("item_envelope_signed");
		itemPackage = new ItemPackage().setUnlocalizedName("item_package").setCreativeTab(MrCrayfishFurnitureMod.tabFurniture);
		...
		itemToilet = new ItemPlacer(FurnitureBlocks.toilet).setUnlocalizedName("item_toilet").setCreativeTab(MrCrayfishFurnitureMod.tabFurniture);
		...
		itemShowerHead = new ItemPlacer(FurnitureBlocks.shower_head_off).setUnlocalizedName("item_shower_head").setCreativeTab(MrCrayfishFurnitureMod.tabFurniture);
		...
		itemPresent = new ItemPresent().setUnlocalizedName("item_present").setCreativeTab(MrCrayfishFurnitureMod.tabFurniture);
		itemTree = new ItemPlacer(FurnitureBlocks.tree_bottom).setUnlocalizedName("item_tree").setCreativeTab(MrCrayfishFurnitureMod.tabFurniture);
