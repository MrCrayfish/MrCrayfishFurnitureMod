...
public class FurnitureCrafting
{
	public static void register()
	{
		...
		GameRegistry.addRecipe(new ItemStack(FurnitureItems.itemPresent, 1, 0), new Object[] { "WWW", "WPW", "WWW", 'W', new ItemStack(Blocks.wool, 1, 15), 'P', FurnitureItems.itemPackage });
		GameRegistry.addRecipe(new ItemStack(FurnitureItems.itemPresent, 1, 1), new Object[] { "WWW", "WPW", "WWW", 'W', new ItemStack(Blocks.wool, 1, 11), 'P', FurnitureItems.itemPackage });
		GameRegistry.addRecipe(new ItemStack(FurnitureItems.itemPresent, 1, 2), new Object[] { "WWW", "WPW", "WWW", 'W', new ItemStack(Blocks.wool, 1, 12), 'P', FurnitureItems.itemPackage });
		GameRegistry.addRecipe(new ItemStack(FurnitureItems.itemPresent, 1, 3), new Object[] { "WWW", "WPW", "WWW", 'W', new ItemStack(Blocks.wool, 1, 9), 'P', FurnitureItems.itemPackage });
		GameRegistry.addRecipe(new ItemStack(FurnitureItems.itemPresent, 1, 4), new Object[] { "WWW", "WPW", "WWW", 'W', new ItemStack(Blocks.wool, 1, 7), 'P', FurnitureItems.itemPackage });
		GameRegistry.addRecipe(new ItemStack(FurnitureItems.itemPresent, 1, 5), new Object[] { "WWW", "WPW", "WWW", 'W', new ItemStack(Blocks.wool, 1, 13), 'P', FurnitureItems.itemPackage });
		GameRegistry.addRecipe(new ItemStack(FurnitureItems.itemPresent, 1, 6), new Object[] { "WWW", "WPW", "WWW", 'W', new ItemStack(Blocks.wool, 1, 3), 'P', FurnitureItems.itemPackage });
		GameRegistry.addRecipe(new ItemStack(FurnitureItems.itemPresent, 1, 7), new Object[] { "WWW", "WPW", "WWW", 'W', new ItemStack(Blocks.wool, 1, 5), 'P', FurnitureItems.itemPackage });
		GameRegistry.addRecipe(new ItemStack(FurnitureItems.itemPresent, 1, 8), new Object[] { "WWW", "WPW", "WWW", 'W', new ItemStack(Blocks.wool, 1, 2), 'P', FurnitureItems.itemPackage });
		GameRegistry.addRecipe(new ItemStack(FurnitureItems.itemPresent, 1, 9), new Object[] { "WWW", "WPW", "WWW", 'W', new ItemStack(Blocks.wool, 1, 1), 'P', FurnitureItems.itemPackage });
		GameRegistry.addRecipe(new ItemStack(FurnitureItems.itemPresent, 1, 10), new Object[] { "WWW", "WPW", "WWW", 'W', new ItemStack(Blocks.wool, 1, 6), 'P', FurnitureItems.itemPackage });
		GameRegistry.addRecipe(new ItemStack(FurnitureItems.itemPresent, 1, 11), new Object[] { "WWW", "WPW", "WWW", 'W', new ItemStack(Blocks.wool, 1, 10), 'P', FurnitureItems.itemPackage });
		GameRegistry.addRecipe(new ItemStack(FurnitureItems.itemPresent, 1, 12), new Object[] { "WWW", "WPW", "WWW", 'W', new ItemStack(Blocks.wool, 1, 14), 'P', FurnitureItems.itemPackage });
		GameRegistry.addRecipe(new ItemStack(FurnitureItems.itemPresent, 1, 13), new Object[] { "WWW", "WPW", "WWW", 'W', new ItemStack(Blocks.wool, 1, 8), 'P', FurnitureItems.itemPackage });
		GameRegistry.addRecipe(new ItemStack(FurnitureItems.itemPresent, 1, 14), new Object[] { "WWW", "WPW", "WWW", 'W', new ItemStack(Blocks.wool, 1, 0), 'P', FurnitureItems.itemPackage });
		GameRegistry.addRecipe(new ItemStack(FurnitureItems.itemPresent, 1, 15), new Object[] { "WWW", "WPW", "WWW", 'W', new ItemStack(Blocks.wool, 1, 4), 'P', FurnitureItems.itemPackage });
