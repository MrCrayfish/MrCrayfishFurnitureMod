...
public class FurnitureBlocks
{
    ...
    static
    {
        ...
        CABINET_OAK = new BlockCabinet(Material.WOOD, SoundType.WOOD).setUnlocalizedName("cabinet_oak").setRegistryName("cabinet_oak");
        CABINET_SPRUCE = new BlockCabinet(Material.WOOD, SoundType.WOOD).setUnlocalizedName("cabinet_spruce").setRegistryName("cabinet_spruce");
        CABINET_BIRCH = new BlockCabinet(Material.WOOD, SoundType.WOOD).setUnlocalizedName("cabinet_birch").setRegistryName("cabinet_birch");
        CABINET_JUNGLE = new BlockCabinet(Material.WOOD, SoundType.WOOD).setUnlocalizedName("cabinet_jungle").setRegistryName("cabinet_jungle");
        CABINET_ACACIA = new BlockCabinet(Material.WOOD, SoundType.WOOD).setUnlocalizedName("cabinet_acacia").setRegistryName("cabinet_acacia");
        CABINET_DARK_OAK = new BlockCabinet(Material.WOOD, SoundType.WOOD).setUnlocalizedName("cabinet_dark_oak").setRegistryName("cabinet_dark_oak");
        ...
        BEDSIDE_CABINET_OAK = new BlockBedsideCabinet(Material.WOOD, SoundType.WOOD).setUnlocalizedName("bedside_cabinet_oak").setRegistryName("bedside_cabinet_oak");
        BEDSIDE_CABINET_SPRUCE = new BlockBedsideCabinet(Material.WOOD, SoundType.WOOD).setUnlocalizedName("bedside_cabinet_spruce").setRegistryName("bedside_cabinet_spruce");
        BEDSIDE_CABINET_BIRCH = new BlockBedsideCabinet(Material.WOOD, SoundType.WOOD).setUnlocalizedName("bedside_cabinet_birch").setRegistryName("bedside_cabinet_birch");
        BEDSIDE_CABINET_JUNGLE = new BlockBedsideCabinet(Material.WOOD, SoundType.WOOD).setUnlocalizedName("bedside_cabinet_jungle").setRegistryName("bedside_cabinet_jungle");
        BEDSIDE_CABINET_ACACIA = new BlockBedsideCabinet(Material.WOOD, SoundType.WOOD).setUnlocalizedName("bedside_cabinet_acacia").setRegistryName("bedside_cabinet_acacia");
        BEDSIDE_CABINET_DARK_OAK = new BlockBedsideCabinet(Material.WOOD, SoundType.WOOD).setUnlocalizedName("bedside_cabinet_dark_oak").setRegistryName("bedside_cabinet_dark_oak");
        ...
        TABLE_OUTDOOR = new BlockOutdoorTable(Material.WOOD, SoundType.WOOD, "table_outdoor").setHardness(2.0f).setResistance(5.0f);
        ...
        BEDSIDE_CABINET_STONE = new BlockBedsideCabinet(Material.ROCK, SoundType.STONE).setUnlocalizedName("bedside_cabinet_stone").setRegistryName("bedside_cabinet_stone");
        BEDSIDE_CABINET_GRANITE = new BlockBedsideCabinet(Material.ROCK, SoundType.STONE).setUnlocalizedName("bedside_cabinet_granite").setRegistryName("bedside_cabinet_granite");
        BEDSIDE_CABINET_DIORITE = new BlockBedsideCabinet(Material.ROCK, SoundType.STONE).setUnlocalizedName("bedside_cabinet_diorite").setRegistryName("bedside_cabinet_diorite");
        BEDSIDE_CABINET_ANDESITE = new BlockBedsideCabinet(Material.ROCK, SoundType.STONE).setUnlocalizedName("bedside_cabinet_andesite").setRegistryName("bedside_cabinet_andesite");
        ...
        DESK_OAK = new BlockDesk(Material.WOOD, SoundType.WOOD).setUnlocalizedName("desk_oak").setRegistryName("desk_oak");
        DESK_SPRUCE = new BlockDesk(Material.WOOD, SoundType.WOOD).setUnlocalizedName("desk_spruce").setRegistryName("desk_spruce");
        DESK_BIRCH = new BlockDesk(Material.WOOD, SoundType.WOOD).setUnlocalizedName("desk_birch").setRegistryName("desk_birch");
        DESK_JUNGLE = new BlockDesk(Material.WOOD, SoundType.WOOD).setUnlocalizedName("desk_jungle").setRegistryName("desk_jungle");
        DESK_ACACIA = new BlockDesk(Material.WOOD, SoundType.WOOD).setUnlocalizedName("desk_acacia").setRegistryName("desk_acacia");
        DESK_DARK_OAK = new BlockDesk(Material.WOOD, SoundType.WOOD).setUnlocalizedName("desk_dark_oak").setRegistryName("desk_dark_oak");
        DESK_STONE = new BlockDesk(Material.ROCK, SoundType.STONE).setUnlocalizedName("desk_stone").setRegistryName("desk_stone");
        DESK_GRANITE = new BlockDesk(Material.ROCK, SoundType.STONE).setUnlocalizedName("desk_granite").setRegistryName("desk_granite");
        DESK_DIORITE = new BlockDesk(Material.ROCK, SoundType.STONE).setUnlocalizedName("desk_diorite").setRegistryName("desk_diorite");
        DESK_ANDESITE = new BlockDesk(Material.ROCK, SoundType.STONE).setUnlocalizedName("desk_andesite").setRegistryName("desk_andesite");
        DESK_CABINET_OAK = new BlockDeskCabinet(Material.WOOD, SoundType.WOOD).setUnlocalizedName("desk_cabinet_oak").setRegistryName("desk_cabinet_oak");
        DESK_CABINET_SPRUCE = new BlockDeskCabinet(Material.WOOD, SoundType.WOOD).setUnlocalizedName("desk_cabinet_spruce").setRegistryName("desk_cabinet_spruce");
        DESK_CABINET_BIRCH = new BlockDeskCabinet(Material.WOOD, SoundType.WOOD).setUnlocalizedName("desk_cabinet_birch").setRegistryName("desk_cabinet_birch");
        DESK_CABINET_JUNGLE = new BlockDeskCabinet(Material.WOOD, SoundType.WOOD).setUnlocalizedName("desk_cabinet_jungle").setRegistryName("desk_cabinet_jungle");
        DESK_CABINET_ACACIA = new BlockDeskCabinet(Material.WOOD, SoundType.WOOD).setUnlocalizedName("desk_cabinet_acacia").setRegistryName("desk_cabinet_acacia");
        DESK_CABINET_DARK_OAK = new BlockDeskCabinet(Material.WOOD, SoundType.WOOD).setUnlocalizedName("desk_cabinet_dark_oak").setRegistryName("desk_cabinet_dark_oak");
        DESK_CABINET_STONE = new BlockDeskCabinet(Material.ROCK, SoundType.STONE).setUnlocalizedName("desk_cabinet_stone").setRegistryName("desk_cabinet_stone");
        DESK_CABINET_GRANITE = new BlockDeskCabinet(Material.ROCK, SoundType.STONE).setUnlocalizedName("desk_cabinet_granite").setRegistryName("desk_cabinet_granite");
        DESK_CABINET_DIORITE = new BlockDeskCabinet(Material.ROCK, SoundType.STONE).setUnlocalizedName("desk_cabinet_diorite").setRegistryName("desk_cabinet_diorite");
        DESK_CABINET_ANDESITE = new BlockDeskCabinet(Material.ROCK, SoundType.STONE).setUnlocalizedName("desk_cabinet_andesite").setRegistryName("desk_cabinet_andesite");
        CABINET_STONE = new BlockCabinet(Material.ROCK, SoundType.STONE).setUnlocalizedName("cabinet_stone").setRegistryName("cabinet_stone");
        CABINET_GRANITE = new BlockCabinet(Material.ROCK, SoundType.STONE).setUnlocalizedName("cabinet_granite").setRegistryName("cabinet_granite");
        CABINET_DIORITE = new BlockCabinet(Material.ROCK, SoundType.STONE).setUnlocalizedName("cabinet_diorite").setRegistryName("cabinet_diorite");
        CABINET_ANDESITE = new BlockCabinet(Material.ROCK, SoundType.STONE).setUnlocalizedName("cabinet_andesite").setRegistryName("cabinet_andesite");
