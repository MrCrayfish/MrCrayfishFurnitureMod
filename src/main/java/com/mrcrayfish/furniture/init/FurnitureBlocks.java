...
public class FurnitureBlocks
{
	...
	static
	{
		...
		MAIL_BOX = new BlockMailBox(Material.WOOD, SoundType.WOOD, "mail_box").setHardness(2.0f).setResistance(5.0f);
	...
	private static void registerBlock(Block block, @Nullable ItemBlock item)
	{
		if (block.getRegistryName() == null)
			throw new IllegalArgumentException("block with class \'" + block.getClass().getName() + "\' being registered does not have a registry name and could be successfully registered.");
