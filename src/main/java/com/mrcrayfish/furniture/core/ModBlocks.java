...
public class ModBlocks
{
    ...
    public static final RegistryObject<Block> SOFA_WHITE = register("white_sofa", new SofaBlock(Block.Properties.copy(Blocks.WHITE_WOOL).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> SOFA_ORANGE = register("orange_sofa", new SofaBlock(Block.Properties.copy(Blocks.ORANGE_WOOL).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> SOFA_MAGENTA = register("magenta_sofa", new SofaBlock(Block.Properties.copy(Blocks.MAGENTA_WOOL).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> SOFA_LIGHT_BLUE = register("light_blue_sofa", new SofaBlock(Block.Properties.copy(Blocks.LIGHT_BLUE_WOOL).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> SOFA_YELLOW = register("yellow_sofa", new SofaBlock(Block.Properties.copy(Blocks.YELLOW_WOOL).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> SOFA_LIME = register("lime_sofa", new SofaBlock(Block.Properties.copy(Blocks.LIME_WOOL).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> SOFA_PINK = register("pink_sofa", new SofaBlock(Block.Properties.copy(Blocks.PINK_WOOL).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> SOFA_GRAY = register("gray_sofa", new SofaBlock(Block.Properties.copy(Blocks.GRAY_WOOL).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> SOFA_LIGHT_GRAY = register("light_gray_sofa", new SofaBlock(Block.Properties.copy(Blocks.LIGHT_GRAY_WOOL).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> SOFA_CYAN = register("cyan_sofa", new SofaBlock(Block.Properties.copy(Blocks.CYAN_WOOL).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> SOFA_PURPLE = register("purple_sofa", new SofaBlock(Block.Properties.copy(Blocks.PURPLE_WOOL).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> SOFA_BLUE = register("blue_sofa", new SofaBlock(Block.Properties.copy(Blocks.BLUE_WOOL).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> SOFA_BROWN = register("brown_sofa", new SofaBlock(Block.Properties.copy(Blocks.BROWN_WOOL).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> SOFA_GREEN = register("green_sofa", new SofaBlock(Block.Properties.copy(Blocks.GREEN_WOOL).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> SOFA_RED = register("red_sofa", new SofaBlock(Block.Properties.copy(Blocks.RED_WOOL).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> SOFA_BLACK = register("black_sofa", new SofaBlock(Block.Properties.copy(Blocks.BLACK_WOOL).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> SOFA_RAINBOW = register("rainbow_sofa", new SofaBlock(Block.Properties.copy(Blocks.WHITE_WOOL).sound(SoundType.WOOD)), new Item.Properties());
    ...
    public static final RegistryObject<Block> TRAMPOLINE = register("trampoline", new TrampolineBlock(Block.Properties.copy(Blocks.STONE)), block -> new TrampolineItem(block, new Item.Properties().tab(FurnitureMod.GROUP)));
    ...
    public static final RegistryObject<Block> DOOR_MAT = register("door_mat", new DoorMatBlock(Block.Properties.copy(Blocks.HAY_BLOCK)), block -> new DoorMatItem(block, new Item.Properties().tab(FurnitureMod.GROUP)));
    ...
    public static final RegistryObject<Block> FREEZER_LIGHT = register("freezer_light", new FreezerBlock(Block.Properties.copy(Blocks.IRON_BLOCK).noOcclusion(), () -> ModBlocks.FRIDGE_LIGHT), (Supplier<BlockItem>) null);
    public static final RegistryObject<Block> FRIDGE_LIGHT = register("fridge_light", new FridgeBlock(Block.Properties.copy(Blocks.IRON_BLOCK).noOcclusion(), () -> ModBlocks.FREEZER_LIGHT), block -> new BlockSupplierItem(new Item.Properties().tab(FurnitureMod.GROUP), block, ModBlocks.FREEZER_LIGHT));
    public static final RegistryObject<Block> FREEZER_DARK = register("freezer_dark", new FreezerBlock(Block.Properties.copy(Blocks.IRON_BLOCK).noOcclusion(), () -> ModBlocks.FRIDGE_DARK), (Supplier<BlockItem>) null);
    public static final RegistryObject<Block> FRIDGE_DARK = register("fridge_dark", new FridgeBlock(Block.Properties.copy(Blocks.IRON_BLOCK).noOcclusion(), () -> ModBlocks.FREEZER_DARK), block -> new BlockSupplierItem(new Item.Properties().tab(FurnitureMod.GROUP), block, ModBlocks.FREEZER_DARK));
