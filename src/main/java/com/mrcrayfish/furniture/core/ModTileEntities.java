...
public class ModTileEntities
{
    ...
    public static final TileEntityType<FridgeTileEntity> FRIDGE = buildType(Names.TileEntity.FRIDGE, TileEntityType.Builder.create(FridgeTileEntity::new, ModBlocks.FRIDGE_LIGHT));
    public static final TileEntityType<FreezerTileEntity> FREEZER = buildType(Names.TileEntity.FREEZER, TileEntityType.Builder.create(FreezerTileEntity::new, ModBlocks.FREEZER_LIGHT));
