...
public class ModTileEntities
{
    ...
    public static class RegistrationHandler
    {
        ...
        public static void register(final RegistryEvent.Register<TileEntityType<?>> event)
        {
            ...
            event.getRegistry().register(DESK_CABINET);
        }
    }
}
