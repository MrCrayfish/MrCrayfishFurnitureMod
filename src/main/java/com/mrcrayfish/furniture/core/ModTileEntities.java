...
public class ModTileEntities
{
    ...
    public static final TileEntityType<FridgeTileEntity> FRIDGE = buildType(TileEntityNames.FRIDGE, TileEntityType.Builder.create(FridgeTileEntity::new, ModBlocks.FRIDGE_LIGHT, ModBlocks.FREEZER_LIGHT));
