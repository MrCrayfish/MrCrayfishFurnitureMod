...
public class ModTileEntities
{
    ...
    public static final TileEntityType<CrateTileEntity> CRATE = buildType(TileEntityNames.CRATE, TileEntityType.Builder.create(CrateTileEntity::new, ModBlocks.DESK_CABINET_OAK, ModBlocks.DESK_CABINET_OAK));
