...
{
    public GrillCookingRecipe(ResourceLocation idIn, String groupIn, CookingBookCategory category, Ingredient ingredientIn, ItemStack resultIn, float experienceIn, int cookTimeIn)
    {
        super(ModRecipeTypes.GRILL_COOKING.get(), idIn, groupIn, category, ingredientIn, resultIn, experienceIn, cookTimeIn);
    }
