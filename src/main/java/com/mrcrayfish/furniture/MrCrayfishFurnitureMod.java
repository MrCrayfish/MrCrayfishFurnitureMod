...
import com.mrcrayfish.furniture.client.RenderEvents;
...
public class MrCrayfishFurnitureMod
{
	...
	public void init(FMLInitializationEvent event)
	{
		...
		/* Entity Registering */
		EntityRegistry.registerModEntity(new ResourceLocation(Reference.MOD_ID, "mountable_block"), EntitySittableBlock.class, "MountableBlock", 0, this, 80, 1, false);
		if (event.getSide() == Side.CLIENT)
		{
			EntityRegistry.registerModEntity(new ResourceLocation(Reference.MOD_ID, "mirror"), EntityMirror.class, "Mirror", 1, this, 80, 1, false);
		}
