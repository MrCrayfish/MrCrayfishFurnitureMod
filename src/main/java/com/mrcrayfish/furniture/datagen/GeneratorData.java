...
public class GeneratorData
{
    ...
    public static final Variant BAMBOO = new Variant("bamboo", () -> Blocks.BAMBOO_PLANKS, () -> Blocks.BAMBOO, null, false);
    public static final Variant[] ALL_VARIANTS = {OAK, BIRCH, SPRUCE, JUNGLE, ACACIA, DARK_OAK, CRIMSON, WARPED, MANGROVE, CHERRY, BAMBOO};
