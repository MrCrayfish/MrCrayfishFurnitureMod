...
public class LootTableGen extends ForgeLootTableProvider
{
    ...
    private static class BlockProvider extends BlockLootTables
    {
        ...
        protected void addTables()
        {
            ...
            this.registerDropSelfLootTable(ModBlocks.COFFEE_TABLE_OAK );
            this.registerDropSelfLootTable(ModBlocks.COFFEE_TABLE_SPRUCE );
            this.registerDropSelfLootTable(ModBlocks.COFFEE_TABLE_BIRCH );
            this.registerDropSelfLootTable(ModBlocks.COFFEE_TABLE_JUNGLE );
            this.registerDropSelfLootTable(ModBlocks.COFFEE_TABLE_ACACIA );
            this.registerDropSelfLootTable(ModBlocks.COFFEE_TABLE_DARK_OAK );
            this.registerDropSelfLootTable(ModBlocks.COFFEE_TABLE_STONE );
            this.registerDropSelfLootTable(ModBlocks.COFFEE_TABLE_GRANITE );
            this.registerDropSelfLootTable(ModBlocks.COFFEE_TABLE_DIORITE );
            this.registerDropSelfLootTable(ModBlocks.COFFEE_TABLE_ANDESITE );
            this.registerDropSelfLootTable(ModBlocks.COFFEE_TABLE_STRIPPED_OAK );
            this.registerDropSelfLootTable(ModBlocks.COFFEE_TABLE_STRIPPED_SPRUCE );
            this.registerDropSelfLootTable(ModBlocks.COFFEE_TABLE_STRIPPED_BIRCH );
            this.registerDropSelfLootTable(ModBlocks.COFFEE_TABLE_STRIPPED_JUNGLE );
            this.registerDropSelfLootTable(ModBlocks.COFFEE_TABLE_STRIPPED_ACACIA );
            this.registerDropSelfLootTable(ModBlocks.COFFEE_TABLE_STRIPPED_DARK_OAK );
