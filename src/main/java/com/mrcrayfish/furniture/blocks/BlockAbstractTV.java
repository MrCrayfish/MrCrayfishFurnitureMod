...
public abstract class BlockAbstractTV extends BlockFurnitureTile
{
	...
	public BlockAbstractTV(Material material, String name, int width, int height, double screenYOffset, double screenZOffset)
	{
		this(material, name, name, width, height, screenYOffset, screenZOffset);
	}

	public BlockAbstractTV(Material material, String registryName, String unlocalizedName, int width, int height, double screenYOffset, double screenZOffset)
	{
