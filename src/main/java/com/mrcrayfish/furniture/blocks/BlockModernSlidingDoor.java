...
public class BlockModernSlidingDoor extends BlockFurniture implements IPowered
{
	...
	public static final AxisAlignedBB[] COLLISION_BOX_BOTTOM = new Bounds(6, 0, 0, 10, 32, 16).getRotatedBounds();
    public static final AxisAlignedBB[] COLLISION_BOX_BOTTOM_OPENED = new Bounds(6 * 0.0625, 0, 0, 10 * 0.0625, 2F, 2.96 * 0.0625).getRotatedBounds();
    public static final AxisAlignedBB[] COLLISION_BOX_TOP = new Bounds(6, -16, 0, 10, 16, 16).getRotatedBounds();
    public static final AxisAlignedBB[] COLLISION_BOX_TOP_OPENED = new Bounds(6 * 0.0625, -1.0, 0, 10 * 0.0625, 1.0, 2.96 * 0.0625).getRotatedBounds();
	...
	public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos)
	{
		...
		return state.getValue(TOP) ? COLLISION_BOX_TOP[facing.getHorizontalIndex()] : COLLISION_BOX_BOTTOM[facing.getHorizontalIndex()];
	}
	...
	public void addCollisionBoxToList(IBlockState state, World worldIn, BlockPos pos, AxisAlignedBB entityBox, List<AxisAlignedBB> collidingBoxes, Entity entityIn, boolean p_185477_7_)
	{
		...
		{
			Block.addCollisionBoxToList(pos, entityBox, collidingBoxes, open ? COLLISION_BOX_TOP_OPENED[facing.getHorizontalIndex()] : COLLISION_BOX_TOP[facing.getHorizontalIndex()]);
		} else
		{
			Block.addCollisionBoxToList(pos, entityBox, collidingBoxes, open ? COLLISION_BOX_BOTTOM_OPENED[facing.getHorizontalIndex()] : COLLISION_BOX_BOTTOM[facing.getHorizontalIndex()]);
		}
	}
