...
public abstract class BlockCurtains extends BlockFurniture
{
    ...
    private static final List<AxisAlignedBB>[] COLLISION_BOXES = Bounds.getRotatedBoundLists(BlockBlinds.TOP, BlockBlinds.BLINDS);
    ...
    {
        return BlockBlinds.BOUNDING_BOX[state.getValue(FACING).getHorizontalIndex()];
    }
