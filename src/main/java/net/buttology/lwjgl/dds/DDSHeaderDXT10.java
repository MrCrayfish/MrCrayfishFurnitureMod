...
class DDSHeaderDXT10
{
    ...
    public int getFormat() {
        switch (dxgiFormat)
        {
            case DXGI_FORMAT_BC1_UNORM:			return DDSFile.GL_COMPRESSED_RGBA_S3TC_DXT1_EXT;
            case DXGI_FORMAT_BC2_UNORM:			return DDSFile.GL_COMPRESSED_RGBA_S3TC_DXT3_EXT;
            case DXGI_FORMAT_BC3_UNORM:			return DDSFile.GL_COMPRESSED_RGBA_S3TC_DXT5_EXT;
            case DXGI_FORMAT_BC4_UNORM:			return GL30.GL_COMPRESSED_RED_RGTC1;
            case DXGI_FORMAT_BC4_SNORM:			return GL30.GL_COMPRESSED_SIGNED_RED_RGTC1;
            case DXGI_FORMAT_BC5_UNORM:			return GL30.GL_COMPRESSED_RG_RGTC2;
            case DXGI_FORMAT_BC5_SNORM:			return GL30.GL_COMPRESSED_SIGNED_RG_RGTC2;
