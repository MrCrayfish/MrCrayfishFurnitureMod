		...
		if (ConfigurationHandler.canDisplay)
		{
			if (!player.worldObj.isRemote)
			{
				if (!ConfigurationHandler.hasDisplayedOnce)
				{
					...
					prefix.getChatStyle().setChatHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new TextComponentString("You can disable this login message in the config")));
					...
					{
					case 0:
						player.addChatMessage(new TextComponentString(TextFormatting.GOLD + PREFIX + TextFormatting.GREEN + "Check out all MrCrayfish's Mods"));
						...
						break;
					case 1:
						player.addChatMessage(new TextComponentString(TextFormatting.GOLD + PREFIX + TextFormatting.GREEN + "Check out the Furniture Mod Wiki"));
						...
						break;
					case 2:
						player.addChatMessage(new TextComponentString(TextFormatting.GOLD + PREFIX + TextFormatting.GREEN + "Check out MrCrayfish's YouTube"));
						...
						break;
					case 3:
						player.addChatMessage(new TextComponentString(TextFormatting.GOLD + PREFIX + TextFormatting.GREEN + "Check out the Community Edition for more Furniture!"));
