...
import com.mrcrayfish.furniture.render.particle.ParticleShower;
	...
	public static Particle spawnParticle(String particleName, double par2, double par4, double par6)
	{
		if (mc != null && mc.getRenderViewEntity() != null && mc.effectRenderer != null)
		{
			...
			else
			{
				...
				{
					var21 = new ParticleShower(mc.theWorld, par2, par4, par6);
				}
				else if (particleName.equals("smoke"))
				{
					var21 = new Particle(mc.theWorld, par2, par4, par6, 0.01, 0.0000001, 0.01);
				}
