...
public class TileEntityMailBox extends TileEntity implements IInventory
{
	...
	public void readFromNBT(NBTTagCompound tagCompound)
	{
		...
		NBTTagList var2 = (NBTTagList) tagCompound.getTag("mailBoxItems");
		if (tagCompound.hasKey("OwnerUUID") && tagCompound.hasKey("OwnerName"))
		{
	...
	public NBTTagCompound writeToNBT(NBTTagCompound tagCompound)
	{
		...
		tagCompound.setTag("mailBoxItems", var2);
		return tagCompound;
	}
