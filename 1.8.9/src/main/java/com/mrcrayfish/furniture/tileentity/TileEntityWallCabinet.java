...
public class TileEntityWallCabinet extends TileEntityLockable implements ISidedInventory
{
	...
	{
		worldObj.playSoundEffect(pos.getX(), pos.getY(), pos.getZ(), "cfm:cabinetopen", 0.75F, 1.0F);
	}

	@Override
	public void closeInventory(EntityPlayer player)
	{
		worldObj.playSoundEffect(pos.getX(), pos.getY(), pos.getZ(), "cfm:cabinetclose", 1.0F, 0.8F);
	}
